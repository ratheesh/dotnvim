...
hl(0 , "CursorLineNr" , { fg = "#f0f0f0" , bg = "#857073" , italic = false , bold = false , underline = false })
...
hl(0 , "CmpItemKindVariable"   	  , { fg = "#000000" , bg = "#C76D83" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindInterface"  	  , { fg = "#e0e0e0" , bg = "#0097BF" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindText"       	  , { fg = "#000000" , bg = "#C586C0" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindFunction"   	  , { fg = "#e0e0e0" , bg = "#50545D" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindMethod"     	  , { fg = "#e0e0e0" , bg = "#4d708c" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindKeyword"    	  , { fg = "#000000" , bg = "#fbb4ae" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindSnippet"    	  , { fg = "#e0e0e0" , bg = "#9467bd" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindConstructor"   , { fg = "#000000" , bg = "#A3BE8C" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindField"         , { fg = "#e0e0e0" , bg = "#9467bd" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindClass"         , { fg = "#e0e0e0" , bg = "#9c755f" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindModule"        , { fg = "#000000" , bg = "#4C5D79" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindProperty"      , { fg = "#000000" , bg = "#A06372" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindUnit"          , { fg = "#e0e0e0" , bg = "#8c755f" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindValue"         , { fg = "#000000" , bg = "#EBCB8B" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindEnum"          , { fg = "#e0e0e0" , bg = "#9467bd" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindColor"         , { fg = "#000000" , bg = "#97B7D7" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindFile"          , { fg = "#000000" , bg = "#E0AF8F" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindReference"     , { fg = "#000000" , bg = "#97B7D7" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindFolder"        , { fg = "#000000" , bg = "#E0AF8F" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindEnumMember"    , { fg = "#e0e0e0" , bg = "#3D7BBF" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindConstant"      , { fg = "#e0e0e0" , bg = "#6B717C" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindStruct"        , { fg = "#000000" , bg = "#af7aa1" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindEvent"         , { fg = "#e0e0e0" , bg = "#3D7BBF" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindOperator"      , { fg = "#000000" , bg = "#bf8da7" , italic = false , bold = false , underline = false })
hl(0 , "CmpItemKindTypeParameter" , { fg = "#000000" , bg = "#97B7D7" , italic = false , bold = false , underline = false })
...
hl(0, "rainbowcol2", { fg = "#BF616A", bg = nil, italic = false, bold = false, underline = false })
...
hl(0, "rainbowcol5", { fg = "teal"   , bg = nil, italic = false, bold = false, underline = false })
hl(0, "rainbowcol6", { fg = "#d5b07B", bg = nil, italic = false, bold = false, underline = false })
hl(0, "rainbowcol7", { fg = "#50AFBB", bg = nil, italic = false, bold = false, underline = false })
